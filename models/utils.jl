...
# Why is inv not implemented for CUDA arrays ....
using CUDA, LinearAlgebra
function cuinv(m::AbstractArray{T}) where T
...
function estimate_lipschitz_lower(model; batches=1, seq_len=3000, plot_res=false, maxIter=300, step_size=1E-2, clip_at=1E-2, init_var=1E-3, verbose=true)
